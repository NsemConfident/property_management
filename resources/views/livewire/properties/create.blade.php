...
layout('components.layouts.app', ['title' => __('Create Property')]);
...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        $validated['owner_id'] = $user->isOwner() ? $user->id : ($user->isManager() ? null : $user->id);
...
<div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div>
            ...
            <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Create Property</h1>
            <p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">Add a new property to the system</p>
        </div>
